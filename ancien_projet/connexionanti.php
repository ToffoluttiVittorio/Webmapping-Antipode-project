...
$query = "SELECT city , population, longitude , latitude FROM villewebmap WHERE latitude > $glat2 AND latitude < $dlat2 AND longitude > $glng2 AND longitude < $dlng2 ORDER BY population DESC LIMIT 5";
